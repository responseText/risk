...
<!--<link rel="stylesheet" href="{{asset('/fontawesome-free-5.3.1-web/css/all.css')}}"> -->
<!-- <link rel="stylesheet" href="{{asset('/fontawesome-free-5.3.1-web/css/all.css')}}"  crossorigin="anonymous"> -->
<!-- Ionicons -->
