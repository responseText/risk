...
class HeadRMReviewController extends Controller
{
  ...
  public function create($id)
  {
    ...
    $data               =   Incident::where([
                              ...
                              ->whereNull('headrm_review_status')->find($id);
    return view('headrmreview.create')
      ->with( 'data' , $data )
  ...
  public function update(Request $request, $id)
  {
    ...
    [
      ...
      {
          return redirect()
                    ->action( 'HeadRMReviewController@create',array($id))
      ...
      $myObj = Incident::where('id', $id)
            ...
            return redirect()
                    ->action('HeadRMReviewController@show',$id )
